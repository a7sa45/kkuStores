      ...
      <div class="w-full lg:w-6/12 flex items-center">
        <div class="mx-auto w-full">
          ...
          <p class="mb-6 text-slate-700">
            متاجر الجامعة نظام لبناء المتاجر الإلكترونية للإدارة والأندية داخل الجامعة.
          </p>
          <div class="mt-10 flex gap-4">
            <a href="/createstore" class="inline-flex justify-center rounded-lg text-sm font-bold py-3 px-4 bg-slate-900 text-white hover:bg-slate-700">
