...
@endauth
@section('content')
<section class="bg-gray-100 rounded-b-10xl overflow-hidden pt-12 pb-24">
      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 lg:w-1/2">
          <div class="mb-6 max-w-md">
            ...
            <h2 class="font-heading mt-6 mb-4 text-xl font-medium md:text-4xl lg:text-5xl">{{ $product->name }}</h2>
            <p class="mb-6 flex items-center">
              <span class="mr-2 text-sm font-medium text-thir">س.ر</span>
              <span class="text-3xl font-medium text-thir">{{ $product->price }}</span>
            </p>
            <p class="text-lg text-gray-400">{{ $product->discription }}</p>
          </div>
         
       
          
          <div class="-mx-2 mb-12 flex flex-wrap">
            @auth
            <div class="mb-2 w-full px-2 md:mb-0 md:w-2/3">
                ...
                <form action="{{ route('cart.store') }}" method="POST">
                    ...
                    <button type="submit" class="font-heading block rounded-xl bg-sec py-4 px-2 text-center text-xl font-medium leading-8 tracking-tighter text-white hover:bg-thir focus:ring-2 focus:ring-thir focus:ring-opacity-50">إضـــافة للعربة</button>
                </form>
                @endif
                @endif
            </div>
        ...
        <div class="w-full lg:w-1/2 px-4 mx-auto mb-16 lg:mb-0">
         
            <div class="w-full mx-auto">
                <img class="h-full w-full mx-auto" src="/images/products/{{ $product->image }}" alt="">
            </div>
      </div>
    </div>
  </section>
...
<section class="relative container px-4 max-w-5xl mx-auto py-16">
    <h2 class="text-xl text-gray-800 font-bold my-4">منتجات قد تعجبك</h2>
